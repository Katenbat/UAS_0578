...
import com.example.uaspcs_18120578.adapter.FavoritAdapter;
import com.example.uaspcs_18120578.model.Favorit;
...
public class FavoritFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final SQLiteDatabase mydatabase = getActivity().openOrCreateDatabase("database_0578",android.content.Context.MODE_PRIVATE,null);
